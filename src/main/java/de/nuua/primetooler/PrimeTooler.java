...
public class PrimeTooler implements ModInitializer {
	...
	public static final String VERSION = "26.0.9.1";
	/**
	...
	/**
	 * WHY: Dev/testing switch to unlock UWU-rank UI for everyone locally.
	 * PERF: Static final flag; checked only in UI gates.
	 */
	public static final boolean FORCE_UWU_ACCESS = false;
