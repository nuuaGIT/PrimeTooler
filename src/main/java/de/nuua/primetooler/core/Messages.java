...
public final class Messages {
	public enum Id {
		...
		LABEL_WARNING_SOUND,
		LABEL_CHAT_MENTION,
		LABEL_ACTIONBAR_MOVE,
		LABEL_TERMINAL_STACK_COUNT,
		LABEL_FISHBAG_TOTAL,
		...
		TOOLTIP_CHAT_MENTION,
		TOOLTIP_ACTIONBAR_MOVE,
		TOOLTIP_TERMINAL_STACK_COUNT,
		TOOLTIP_FISHBAG_TOTAL,
		...
		DOUBLE_DROP_CONFIRM,
		CHAT_MENTION_ALERT,
		CHAT_MENTION_TOAST_TITLE,
		FISHBAG_TOTAL_FORMAT,
		FISHBAG_WEIGHT_FORMAT,
